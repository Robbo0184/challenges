...
const newTeaser = document.createElement('article')
newTeaser.classList.add('second-teaser')

document.body.append(newTeaser)

const secondTeaser = document.querySelector('.second-teaser')
...
secondTeaser.innerHTML += productHTML
